...
import jfreechart.JFreeChartDemo;
...
public class FreemarkerWordDemo {
	...
	public void WriteDocFile() throws TemplateException, IOException{
		LinkedHashMap<String, Object> map = new LinkedHashMap<String, Object>();
		 //设置template.xml路径
		 conf.setClassForTemplateLoading(FreemarkerWordDemo.class, "/org/javalusir/freemarker/");
		 ...
		 map.put("id", "123122qq");
		 map.put("name","王强");
		 map.put("image", JFreeChartDemo.getBase64ImageStr(JFreeChartDemo.writeBarPic()));
